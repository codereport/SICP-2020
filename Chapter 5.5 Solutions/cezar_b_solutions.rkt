...
(define (spread-arguments operands)
  ...
  (define (next-reg)
    ...
    (string->symbol (format "reg~a" reg-counter)))
  (map (lambda (operand)
         (compile operand (next-reg) 'next))
       operands))
...
(()
  (val)
  ((((env) (reg1) ((assign reg1 (op lookup-variable-value) (const a) (reg env))))
    (() (reg2) ((assign reg2 (const 1)))))
