...
;         here
         ...
         there)))
    (start ex58-machine)
    (check-equal? (get-register-contents ex58-machine 'a) 3)))

; Ex 5.13 - Modified get-register
    ...
    (define gcd-machine2
      (make-machine
       ...
       '(test-b (test (op =) (reg b) (const 0))
            ...
            (goto (label test-b))
            gcd-done)))
    (set-register-contents! gcd-machine2 'a 206)
    (set-register-contents! gcd-machine2 'b 40)
    (start gcd-machine2)
    (check-equal? (get-register-contents gcd-machine2 'a) 2)))

; Ex 5.16 - Modified make-new-machine -> execute
